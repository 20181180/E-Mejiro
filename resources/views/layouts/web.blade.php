        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li class="wishlist"><a href="#"><span>Hola</span></a></li>
              <li class="header_cart hidden-xs"><a href="#"><span>My Carrito</span></a></li>
              <li class="check"><a href="#"><span>Pagos</span></a></li>
              <li class="login"><a href="{{ route('login') }}"><span>Inicar Sesion</span></a></li>
            </ul>
          </div>
          <!-- /.cnt-account -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
            <!-- ============================================================= LOGO ============================================================= -->
            <div class="logo"> <a href="#"> <img src="marazzo/assets/images/paypal.png" style="width: 230px;" alt="logo"> </a> </div>
            <!-- /.logo -->
            <!-- ============================================================= LOGO : END ============================================================= -->
          </div>
          <!-- /.logo-holder -->
                  ...
                  <ul class="categories-filter animate-dropdown">
                    <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="category.html">Categorias <b class="caret"></b></a>
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">Producto1</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Producto2</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Producto3</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Produco4</a></li>
                      </ul>
                    </li>
                  </ul>
          ...
          <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 animate-dropdown top-cart-row">
            <!-- ============================================================= seccion de carrito de compra en el menu lateral ============================================================= -->

            <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                <div class="items-cart-inner">
                  <div class="basket">
                    <div class="basket-item-count"><span class="count">2</span></div>
                    <div class="total-price-basket"> <span class="lbl">Carrito de Compra</span> <span class="value">$4580</span> </div>
                  </div>
                </div>
              </a>
              <ul class="dropdown-menu">
                <li>
                  ...
                  <div class="clearfix cart-total">
                    ...
                    <div class="clearfix"></div>
                    <a href="checkout.html" class="btn btn-upper btn-primary btn-block m-t-20">Finalizar compras</a>
                  </div>
                  <!-- /.cart-total-->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="module-body">
              <ul class='list-unstyled'>
                ...
                <li><a href="#" title="About us">Historial de ordenes</a></li>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="module-body">
              <ul class='list-unstyled'>
                <li class="first"><a title="Your Account" href="#">Hacerca de nosotros</a></li>
