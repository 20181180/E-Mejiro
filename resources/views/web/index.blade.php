    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
        ...
        <div class="sidebar-widget newsletter outer-bottom-small">
          <h3 class="section-title">Hola mundo</h3>
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">Hola</a></li>
              <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">Pruba1</a></li>
              <li><a data-transition-type="backSlide" href="#laptop" data-toggle="tab">Electronicos</a></li>
              <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Hola mundo</a></li>
            </ul>
            <!-- /.nav-tabs -->
          </div>
